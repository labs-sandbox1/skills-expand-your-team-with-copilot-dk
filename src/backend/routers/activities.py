...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced'). 
                  If not provided, returns all activities regardless of difficulty level.
    """
    ...
    if difficulty:
        # Filter by specific difficulty level only (Beginner, Intermediate, Advanced)
        # When no difficulty filter is provided, all activities are returned
